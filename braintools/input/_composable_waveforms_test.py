...
from braintools.input._composable_waveforms import (
    SinusoidalInput, SquareInput, TriangularInput,
    SawtoothInput, ChirpInput, NoisySinusoidalInput
)
from braintools.input._composable_basic import RampInput, ConstantInput, StepInput
...
class TestSinusoidalInput(TestCase):
    """Test SinusoidalInput class."""
...
class TestNoisySinusoidalInput(TestCase):
    """Test NoisySinusoidalInput class."""
