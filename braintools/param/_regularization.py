...
class GaussianReg(Regularization):
    ...
    def loss(self, value: Data) -> Data:
        ...
        """
        weight = u.math.relu(get_param(self.weight))
...
class ElasticNetReg(Regularization):
    ...
    def loss(self, value: Data) -> Data:
        ...
        """
        alpha = u.math.clip(get_param(self.alpha), 0.0, 1.0)
        l1_weight = u.math.relu(get_param(self.l1_weight))
        l2_weight = u.math.relu(get_param(self.l2_weight))

        l1_loss = l1_weight * u.math.sum(u.math.abs(value))
        l2_loss = l2_weight * u.math.sum(value ** 2)
    ...
    def sample_init(self, shape: Size) -> Data:
        ...
        """
        alpha = u.math.clip(get_param(self.alpha), 0.0, 1.0)
        l1_weight = u.math.relu(get_param(self.l1_weight)) + 1e-8
        l2_weight = u.math.relu(get_param(self.l2_weight)) + 1e-8
...
class HuberReg(Regularization):
    ...
    def loss(self, value: Data) -> Data:
        ...
        """
        weight = u.math.relu(get_param(self.weight))
        delta = u.math.relu(get_param(self.delta)) + 1e-8
        ...
        return weight * u.math.sum(huber)
    ...
    def sample_init(self, shape: Size) -> Data:
        ...
        weight = u.math.relu(get_param(self.weight)) + 1e-8
        std = 1.0 / u.math.sqrt(weight)
        return std * brainstate.random.randn(*get_size(shape))
...
class GroupLassoReg(Regularization):
    ...
    def loss(self, value: Data) -> Data:
        ...
        return weight * u.math.sum(group_norms)
...
class TotalVariationReg(Regularization):
    ...
    def loss(self, value: Data) -> Data:
        ...
        return weight * u.math.sum(u.math.abs(diff))
    ...
    def sample_init(self, shape: Size) -> Data:
        ...
        return u.math.cumsum(noise.flatten()).reshape(get_size(shape)) / u.math.sqrt(float(u.math.prod(u.math.asarray(get_size(shape)))))
...
class MaxNormReg(Regularization):
    ...
    def loss(self, value: Data) -> Data:
        ...
        """
        weight = u.math.relu(get_param(self.weight))
        max_val = u.math.relu(get_param(self.max_value)) + 1e-8
...
class OrthogonalReg(Regularization):
    ...
    def loss(self, value: Data) -> Data:
        ...
        diff = WtW - I
        return weight * u.math.sum(diff ** 2)
...
class StudentTReg(Regularization):
    ...
    def loss(self, value: Data) -> Data:
        ...
        """
        weight = u.math.relu(get_param(self.weight))
        df = u.math.relu(get_param(self.df)) + 1e-8
        scale = u.math.relu(get_param(self.scale)) + 1e-8

        z = value / scale
        return weight * u.math.sum(u.math.log(1.0 + z ** 2 / df))
...
class CauchyReg(Regularization):
    ...
    def loss(self, value: Data) -> Data:
        ...
        z = value / scale
        return weight * u.math.sum(u.math.log(1.0 + z ** 2))
...
class UniformReg(Regularization):
    ...
    def loss(self, value: Data) -> Data:
        ...
        """
        weight = u.math.relu(get_param(self.weight))
        lower = get_param(self.lower)
        upper = get_param(self.upper)

        below = u.math.relu(lower - value) ** 2
        above = u.math.relu(value - upper) ** 2
        return weight * u.math.sum(below + above)
    ...
    def reset_value(self) -> Data:
        ...
        array_like
            (lower + upper) / 2.
        """
        return (get_param(self.lower) + get_param(self.upper)) / 2.0
...
class LogNormalReg(Regularization):
    ...
    def loss(self, value: Data) -> Data:
        ...
        """
        weight = u.math.relu(get_param(self.weight))
        mu = get_param(self.mu)
        sigma = u.math.relu(get_param(self.sigma)) + 1e-8

        # Ensure positive values
        x_pos = u.math.relu(value) + 1e-8
        log_x = u.math.log(x_pos)
        return weight * u.math.sum((log_x - mu) ** 2 / (2 * sigma ** 2) + log_x)
    ...
    def reset_value(self) -> Data:
        ...
        array_like
            exp(mu).
        """
        return u.math.exp(get_param(self.mu))
...
class GammaReg(Regularization):
    ...
    def loss(self, value: Data) -> Data:
        ...
        """
        weight = u.math.relu(get_param(self.weight))
        alpha = u.math.relu(get_param(self.alpha)) + 1e-8
        beta = u.math.relu(get_param(self.beta)) + 1e-8

        # Ensure positive values
        x_pos = u.math.relu(value) + 1e-8
        # Negative log-likelihood (ignoring constants)
        return weight * u.math.sum(-(alpha - 1) * u.math.log(x_pos) + beta * x_pos)
...
class BetaReg(Regularization):
    ...
    def loss(self, value: Data) -> Data:
        ...
        """
        weight = u.math.relu(get_param(self.weight))
        a = u.math.relu(get_param(self.a)) + 1e-8
        b = u.math.relu(get_param(self.b)) + 1e-8

        # Clip to (0, 1) for numerical stability
        x_clip = u.math.clip(value, 1e-8, 1.0 - 1e-8)
        # Negative log-likelihood (ignoring constants)
        return weight * u.math.sum(-(a - 1) * u.math.log(x_clip) - (b - 1) * u.math.log(1 - x_clip))
...
class HorseshoeReg(Regularization):
    ...
    def loss(self, value: Data) -> Data:
        ...
        """
        weight = u.math.relu(get_param(self.weight))
        tau = u.math.relu(get_param(self.tau)) + 1e-8
...
class LogUniformReg(Regularization):
    ...
    def loss(self, value: Data) -> Data:
        ...
        """
        weight = u.math.relu(get_param(self.weight))
        lower = u.math.relu(get_param(self.lower)) + 1e-8
        upper = u.math.relu(get_param(self.upper)) + 1e-8
        ...
        return weight * u.math.sum(u.math.log(x_pos))
...
class SpikeAndSlabReg(Regularization):
    ...
    def loss(self, value: Data) -> Data:
        ...
        """
        weight = u.math.relu(get_param(self.weight))
        spike_scale = u.math.relu(get_param(self.spike_scale)) + 1e-8
        slab_scale = u.math.relu(get_param(self.slab_scale)) + 1e-8
        pi = u.math.clip(get_param(self.pi), 1e-8, 1.0 - 1e-8)
        ...
        return weight * u.math.sum(-u.math.log(mixture + 1e-8))
...
class DirichletReg(Regularization):
    ...
    def loss(self, value: Data) -> Data:
        ...
        return weight * u.math.sum(-(alpha - 1) * u.math.log(probs + 1e-8))
