...
class TestCrossCorrelation(unittest.TestCase):
    ...
    def test_cc2(self):
        spikes = brainstate.random.randint(0, 2, (1000, 10))
        print(braintools.metric.cross_correlation(spikes, 1.))
        print(braintools.metric.cross_correlation(spikes, 0.5))
        

    def test_cc3(self):
        spikes = brainstate.random.random((1000, 100)) < 0.8
        print(braintools.metric.cross_correlation(spikes, 1.))
        print(braintools.metric.cross_correlation(spikes, 0.5))
        

    def test_cc4(self):
        spikes = brainstate.random.random((1000, 100)) < 0.2
        print(braintools.metric.cross_correlation(spikes, 1.))
        print(braintools.metric.cross_correlation(spikes, 0.5))
        

    def test_cc5(self):
        spikes = brainstate.random.random((1000, 100)) < 0.05
        print(braintools.metric.cross_correlation(spikes, 1.))
        print(braintools.metric.cross_correlation(spikes, 0.5))
    ...
    def test_cross_correlation_bounds(self):
        ...
        spikes = brainstate.random.random((100, 20)) < 0.3
    ...
    def test_cross_correlation_single_neuron(self):
        ...
        spikes = brainstate.random.random((100, 1)) < 0.3
        cc = braintools.metric.cross_correlation(spikes, 1.0)
    ...
    def test_cross_correlation_methods(self):
        ...
        spikes = brainstate.random.random((50, 10)) < 0.4
...
class TestVoltageFluctuation(unittest.TestCase):
    def test_vf1(self):
        voltages = brainstate.random.normal(0, 10, size=(100, 10))
    ...
    def test_voltage_fluctuation_synchronized(self):
        ...
        voltages = []
        for i in range(10):
            noise = brainstate.random.normal(0, 0.5, size=100)  # Small noise
    ...
    def test_voltage_fluctuation_asynchronous(self):
        ...
        voltages = brainstate.random.normal(0, 1, size=(100, 10))
        sync_index = braintools.metric.voltage_fluctuation(voltages)
    ...
    def test_voltage_fluctuation_methods(self):
        """Test that loop and vmap methods give same results."""
        voltages = brainstate.random.normal(0, 1, size=(50, 8))
    ...
    def test_voltage_fluctuation_single_neuron(self):
        ...
        voltages = brainstate.random.normal(0, 1, size=(100, 1))
        sync_index = braintools.metric.voltage_fluctuation(voltages)
...
class TestFunctionalConnectivity(unittest.TestCase):
    def test_cf1(self):
        act = brainstate.random.random((10000, 3))
    ...
    def test_functional_connectivity_properties(self):
        ...
        activities = brainstate.random.normal(0, 1, size=(1000, 5))
    ...
    def test_functional_connectivity_perfect_correlation(self):
        ...
        base_signal = brainstate.random.normal(0, 1, size=1000)
    ...
    def test_functional_connectivity_input_validation(self):
        ...
        # Test valid 2D input
        activities = brainstate.random.normal(0, 1, size=(100, 3))
        fc = braintools.metric.functional_connectivity(activities)
...
class TestMatrixCorrelation(unittest.TestCase):
    def test_mc(self):
        A = brainstate.random.random((100, 100))
        B = brainstate.random.random((100, 100))
    ...
    def test_matrix_correlation_identical(self):
        ...
        A = brainstate.random.random((50, 50))
    ...
    def test_matrix_correlation_symmetric(self):
        ...
        A = brainstate.random.random((30, 30))
        B = brainstate.random.random((30, 30))
    ...
    def test_matrix_correlation_bounds(self):
        ...
        A = brainstate.random.random((25, 25))
        B = brainstate.random.random((25, 25))
...
class TestFunctionalConnectivityDynamics(unittest.TestCase):
    def test_fcd_basic(self):
        ...
        activities = brainstate.random.normal(0, 1, size=(200, 10))
    ...
    def test_fcd_parameter_validation(self):
        ...
        activities = brainstate.random.normal(0, 1, size=(100, 5))
    ...
    def test_fcd_consistent_patterns(self):
        ...
        sig3 = brainstate.random.normal(0, 1, size=200)  # Uncorrelated
    ...
    def test_fcd_bounds(self):
        ...
        activities = brainstate.random.normal(0, 1, size=(150, 8))
...
class TestWeightedCorrelation(unittest.TestCase):
    ...
    def test_weighted_correlation_vs_unweighted(self):
        ...
        x = brainstate.random.normal(0, 1, size=100)
        y = 2 * x + brainstate.random.normal(0, 0.1, size=100)
    ...
    def test_weighted_correlation_bounds(self):
        ...
        x = brainstate.random.normal(0, 1, size=50)
        y = brainstate.random.normal(0, 1, size=50)
        w = brainstate.random.uniform(0.1, 2.0, size=50)  # Random positive weights
    ...
    def test_weighted_correlation_jit_compatibility(self):
        ...
        x = brainstate.random.normal(0, 1, size=20)
        y = brainstate.random.normal(0, 1, size=20)
        w = jnp.ones(20)
